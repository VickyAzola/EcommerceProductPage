...
function Credits() {
    ...
    <footer className="text-center text-xs text-gray-400 mt-4">
        ...
        Challenge by 
            <a  className="font-bold hover:text-Orange"
            ...
            Coded by 
            <a  className="group flex gap-x-1 font-bold hover:text-Orange"
                aria-label='Go to Victoria Azola Github' 
                target="_blank" 
                href="https://github.com/VickyAzola/EcommerceProductPage" 
                rel="noreferrer" >
                <svg className="w-4 h-4 fill-gray-400 group-hover:fill-Orange"
