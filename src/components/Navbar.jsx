  ...
  // Toggle function to handle the navbar's display
    ...
    <>
        ...
        <div className='relative flex gap-x-5 lg:gap-x-10 items-center w-full justify-end'>
            ...
            <div>
                <span className={
                    `${props.animation && 'animate-ping animate-once'} 
                    absolute top-[-10%] lg:top-1 lg:right-[5rem] right-12 bg-orange-300 opacity-75 h-4 w-4 rounded-full`
                    }></span>
                <div
                className='absolute top-[-10%] lg:top-1 lg:right-[5rem] right-12 bg-Orange h-4 w-4 text-white 
                font-bold rounded-full grid place-content-center text-[.6rem] xl:text-xs'>
                    {props.cuantity} 
                </div>
            </div>
            }
